//
//  MagnetsCardsDetailViewController.swift
//  prinsta_pick
//
...
class MagnetsCardsDetailViewController: BaseViewController,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if collectionView.tag == 0 {
            ...
            cell.selectButton.addTarget(self, action: #selector(selectedButtonClicked(sender :)), for: .touchUpInside)
        }
        return cell
    }
...
//    }
    ...
    @objc func selectedButtonClicked( sender : UIButton) {
