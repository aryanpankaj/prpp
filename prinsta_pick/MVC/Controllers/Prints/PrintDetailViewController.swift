...
class PrintDetailViewController: BaseViewController,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,SelectPackageDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.navTitle.text = "Print Detail"
    ...
    @IBAction func selectButtonClicked(_ sender: Any) {
        ...
        let vc = storyBoard.instantiateViewController(withIdentifier: "printPackageViewController") as! PrintPackageViewController
        vc.selectedpkgDelegate = self
    ...
    func selectedPackageDelegate(pkge_name: String, discount_per: String, print_price : String) {
        ...
        AppHelper.delay(0.5) {
            ...
            vc.comeFrom = PrintingType.Prints.rawValue
            vc.print_type =  self.print_type
            vc.print_price = self.print_price
            vc.print_size =  self.print_size
            vc.print_discount = discount_per
            vc.selected_pkg = pkge_name
