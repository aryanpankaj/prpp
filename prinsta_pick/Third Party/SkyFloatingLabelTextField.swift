...
open class SkyFloatingLabelTextField: UITextField { // swiftlint:disable:this type_body_length
    ...
    static let SFRegularfont14 = UIFont(name: "Raleway-Regular", size: 16)!
    static let SFRegularfont15 = UIFont(name: "Raleway-Regular", size: 17)!
    ...
    @objc dynamic open var placeholderFont: UIFont = SFRegularfont14 {
        didSet {
            updatePlaceholder()
        }
    }
    ...
    @objc dynamic open var titleFont: UIFont = SFRegularfont14 {
        didSet {
            updateTitleLabel()
        }
    }
    ...
    */
    override public init(frame: CGRect) {
        ...
        self.font = SkyFloatingLabelTextField.SFRegularfont15
    }
    ...
    */
    ...
    override open func textRect(forBounds bounds: CGRect) -> CGRect {
        if #available(iOS 11.0, *) {
            ...
            let titleHeight = self.titleHeight() - self.titleHeight()
    ...
    */
    ...
    open var isLeftImage = false
    open func titleLabelRectForBounds(_ bounds: CGRect, editing: Bool) -> CGRect {
        
        if #available(iOS 11.0, *) {
            margin = 4
            if editing {
                return CGRect(x: 0, y: -titleHeight() + (3 * margin/2), width: bounds.size.width, height: titleHeight())
            }
            return CGRect(x: 0, y:0, width: bounds.size.width, height: titleHeight())
        }else if #available(iOS 10.0, *) {
            if editing {
                return CGRect(x: 0, y: -titleHeight() + (3 * margin), width: bounds.size.width, height: titleHeight())
            }
            return CGRect(x: 0, y:0, width: bounds.size.width, height: titleHeight())
        }else {
            margin = 4
            if editing {
                return CGRect(x: 0, y: -titleHeight() + (5 * margin/2) - 2 , width: bounds.size.width, height: titleHeight() + 10)
            }
            return CGRect(x: 0, y:0, width: bounds.size.width, height: titleHeight())
        }
    }
